...
/** The uniform analytics read sub-API; here it answers from the cross-domain store. */
@Tag(name = "analytics", description = "Uniform domain analytics read API (cross-domain)")
@RestController
...
public class AnalyticsController {
    ...
    @Operation(summary = "Cross-domain analytics summary for an account")
    @GetMapping("/summary")
    ...
    @Operation(summary = "Recent cross-domain activity feed for an account")
    @GetMapping("/activity")
