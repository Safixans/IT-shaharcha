...
@RestController
@RequestMapping("/api/v1/assessment/quizzes")
...
public class QuizController {
    ...
    public ApiResponse<PageResponse<UnitMeta>> list(
        ...
        return ApiResponse.ok(units.browse(UnitKind.QUIZ, null, !SecurityUtils.isAuthor(), tags,
    ...
    public ApiResponse<UnitDetail> create(@Valid @RequestBody ObjectiveUnitCreate body) {
        return ApiResponse.ok(units.create(UnitKind.QUIZ, body));
    }
