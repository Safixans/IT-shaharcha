...
/**
 * Canonical platform event envelope (shared/events.yaml). Portfolio emits these to
 * the {@code itsh.portfolio.events} topic, keyed by {@code actor.accountId}.
 */
...
public record DomainEvent(
    ...
    public static final String TOPIC = "itsh.portfolio.events";
    public static final String SOURCE = "portfolio";
